...
# fast deterministic logic tests (layout, raise, reactor, config) — no GUI
test:
    nix develop -c cargo test --lib -- layout_engine actor::raise_manager actor::reactor::tests common::config --skip topology_change_clears_stale_pending_hide_target
